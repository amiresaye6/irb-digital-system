...
class Reviews {
    ...
    public function assignReviewer($application_id, $reviewer_id, $admin_id) {
        ...
        // Insert with assignment_status = 'awaiting_acceptance' (default), decision = 'pending'
        $sql = "INSERT INTO reviews (application_id, reviewer_id, assigned_by, assignment_status, decision) VALUES (?, ?, ?, 'awaiting_acceptance', 'pending')";
        $stmt = $this->db->prepare($sql);

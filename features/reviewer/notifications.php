...
if (isset($_POST['mark_all_read'])) {
    $appObj->markAllNotificationsRead($reviewer_id);
    header("Location: notifications.php"); 
    exit;
}

// Reusing the generic notifications queries
$notifications = $appObj->getStudentNotifications($reviewer_id);
$unreadCount = $appObj->getUnreadNotificationCount($reviewer_id);
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>إشعارات المراجع | نظام إدارة الموافقات البحثية</title>
...
<body>
    ...
    <div class="content">
        <h2 class="page-title"><i class="fa-solid fa-bell"></i> إشعارات المراجع</h2>

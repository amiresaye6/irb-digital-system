...
$notification = $appObj->getNotificationById($notif_id, $sampler_id);
...
if (!$notification['is_read']) {
    $appObj->markNotificationRead($notif_id, $sampler_id);
}
...
$actionUrl = "process_application.php?id=" . $app['id'];
    ...
    <div class="content">
        ...
        <div class="notif-detail-card">
            <div class="notif-header">
                <div class="notif-icon-large"><i class="fa-solid fa-calculator"></i></div>
                <div class="notif-meta-info">
                    ...
                    <h3 class="notif-main-title">طلب حساب حجم العينة</h3>
                </div>
            </div>
            ...
            <div class="actions-area">
                <a href="<?= $actionUrl ?>" class="btn-action">
                    <i class="fa-solid fa-arrow-up-right-from-square"></i> الذهاب إلى حساب العينة
                </a>
